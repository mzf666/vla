...
- **任务泛化** —— 用一句话把它 prompt 到新任务上。适配新任务的通道就是那句话：换活儿等于写一条新指令，不用重新采数据、重新起训练 [[arXiv:2604.15483 §V]](https://arxiv.org/abs/2604.15483)。评测覆盖 14 个场景，每个场景 3 到 6 条开放式指令，环境是没见过的厨房和卧室 [[arXiv:2604.15483 §IX-B]](https://arxiv.org/abs/2604.15483)。
